 ...
 */
public class ListGurusAdapter_old extends BaseExpandableListAdapter {

    private Context _context;
    private ArrayList<String> _listTags;
    private HashMap<String, ArrayList<Guru>> _listGurus;

    public ListGurusAdapter_old(Context context, ArrayList<String> listTags, HashMap<String, ArrayList<Guru>> listGurus) {
